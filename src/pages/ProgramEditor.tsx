...
export function ProgramEditor() {
  ...
  const addExercise = (day: DaySet, type: WorkoutType) => {
    ...
    setWorkouts((prev) => ({
      ...prev,
      [day]: { ...prev[day], [type]: [...prev[day][type], newEx] },
    }));
  };

  const deleteExercise = (day: DaySet, type: WorkoutType, idx: number) => {
    setWorkouts((prev) => ({
      ...prev,
      [day]: {
        ...prev[day],
        [type]: prev[day][type].filter((_, i) => i !== idx),
      },
    }));
  };
    ...
    <div className="max-w-lg mx-auto px-4 pt-6 pb-28">
      ...
      <div className="space-y-3 mb-5">
        {exercises.map((ex, idx) => (
          <div key={ex.id} className="bg-zinc-800 rounded-xl p-3">
            <div className="flex items-center gap-2 mb-2">
              ...
              />
              <button
                onClick={() => deleteExercise(activeDay, activeTab, idx)}
      ...
      <button
        onClick={() => addExercise(activeDay, activeTab)}
